...
const LinkCard = ({title, bglink, style ,textColor, link}: LinkCardProps) => {
  return (
    <Link href={link?link:'./'} className={`bg-slate-100 border-transparent border-2 p-6 rounded-3xl w-full h-full flex flex-col justify-between ${bglink} ${style} hover:border-2 hover:border-gray-200 `}>
