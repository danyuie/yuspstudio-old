      ...
      {!navbar ? '': (
        <div className='fixed top-0 right-0 bg-white p-4 w-screen h-screen flex flex-col justify-between z-10 pb-7 md:p-7'>
          <div className='flex justify-between items-start h-1/6'>
            <div className='tracking-tighter font-semibold text-4xl text-stone-950 md:text-5xl h-full items-center flex md:block'>Menu.</div>
          ...
          <div className='flex flex-col gap-2 h-full md:gap-4'>
            ...
            <div className='flex gap-2 h-full md:gap-4'>
              ...
              <div className='flex flex-col gap-2 w-1/2 h-full duration-200 md:gap-4'>
                ...
                <LinkCard handle={handel} style='hover:drop-shadow-2xl bg-transparent border-slate-200 hover:bg-slate-100 group hover:bg-slate-950' link='./contact' title='Our Contact' textColor='text-slate-800 group-hover:text-slate-50'/>
              </div>
            </div>
          </div>
        </div>
